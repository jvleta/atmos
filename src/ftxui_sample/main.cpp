...
// configuration step. It creates a namespace called `atmos`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", atmos::cmake::project_name, atmos::cmake::project_version) };
